...
dialog --title "Warning" --yesno "This is an older version of PortMaster that has been modified to work with Batocera. Tested on v39 Raspberry PI 3b+. It is experimental and not supported by Batocera PRO or the Portmaster Dev team--no support will be offered for using this version. Proceed?" 10 60
