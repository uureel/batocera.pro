...
dialog --title "Warning" --yesno "This version of PortMaster has been modified to work with Batocera. Tested on v39 Rasbpberry PI 3b+. It is experimental and not supported by Batocera PRO--no support will be offered for using this version. Proceed?" 10 60
