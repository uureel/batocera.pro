...
apps=(
    ...
    ["APPLEWIN/WINE"]="curl -Ls https://github.com/uureel/batocera.pro/raw/main/applewin/applewin.sh | bash"
    ["ATOM"]="curl -Ls atom.batocera.pro | bash"
    ["BALENA-ETCHER"]="curl -Ls balena.batocera.pro | bash"
    ["BATTLE.NET/WINE"]="curl -Ls battlenet.batocera.pro | bash"
    ...
    ["SHEEPSHAVER"]="curl -Ls https://github.com/uureel/batocera.pro/raw/main/sheepshaver/install.sh | bash"
