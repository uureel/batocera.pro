...
apps=(
    ...
    ["MINECRAFT"]="curl -Ls minecraft.batocera.pro | bash"
    ...
    ["**UPDATE-THIS-SCRIPT**"]="curl -Ls https://github.com/uureel/batocera.pro/raw/main/app/install.sh | bash"
    ...
    ["XCLOUD"]="curl -Ls https://github.com/uureel/batocera.pro/raw/main/xcloud/xcloud.sh | bash"
