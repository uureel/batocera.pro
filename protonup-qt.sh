...
#       DEFINE APP INFO >> 
APPNAME=boxes
APPHOME="github.com/ivan-hc/Boxes-appimage"
#---------------------------------------------------------------------

# Fetch the latest release download URL from GitHub API and find the first .AppImage file
APPLINK=$(wget -qO- https://api.github.com/repos/ivan-hc/Boxes-appimage/releases/latest | grep "browser_download_url.*AppImage" | cut -d : -f 2,3 | tr -d \")
