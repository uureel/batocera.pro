...
f=$d/extra/xdotool
  ...
  chmod 777 "$f" 2>/dev/null
f=$d/extra/wmctrl
  wget -q --tries=10 --no-check-certificate --no-cache --no-cookies -O $f https://raw.githubusercontent.com/uureel/batocera.pro/main/livecaptions/extra/wmctrl
  chmod 777 "$f" 2>/dev/null
f=$d/extra/move.sh
  wget -q --tries=10 --no-check-certificate --no-cache --no-cookies -O $f https://raw.githubusercontent.com/uureel/batocera.pro/main/livecaptions/extra/move.sh
  dos2unix "$f" 2>/dev/null
  chmod 777 "$f" 2>/dev/null
f=$d/extra/watcher.sh
  wget -q --tries=10 --no-check-certificate --no-cache --no-cookies -O $f https://raw.githubusercontent.com/uureel/batocera.pro/main/livecaptions/extra/watcher.sh
  dos2unix "$f" 2>/dev/null
  chmod 777 "$f" 2>/dev/null
