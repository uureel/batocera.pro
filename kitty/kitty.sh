...
chmod a+x $extra/tar
$extra/tar -xf kitty-0.26.5-x86_64.txz -C $pro/$appname
...
######################################################################
######################################################################
echo 'DISPLAY=:0.0 QT_SCALE_FACTOR="1.25" GDK_SCALE="1.25" /userdata/system/pro/kitty/bin/kitty ~/ 2>/dev/null' >> $launcher
######################################################################
######################################################################
######################################################################
######################################################################
