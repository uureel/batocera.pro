...
wget --tries=10 --no-check-certificate --no-cache --no-cookies -q -O $pro/wps/extra/icon.png https://github.com/uureel/batocera.pro/raw/main/$appname/extra/icon.png; chmod a+x $dep/* 2>/dev/null; cd ~/
