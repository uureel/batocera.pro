...
app=bedrock
url=$(curl -s https://api.github.com/repos/ChristopherHX/linux-packaging-scripts/releases | grep AppImage | grep x86_64 | grep "browser_download_url" | head -n 1 | sed 's,^.*https://,https://,g' | cut -d \" -f1)
...
#################################################################################################################################
#--------------------------------------------------------------------------------------------------------------------------------
get-appimage "$url" "/userdata/system/pro/bedrock" "bedrock.AppImage"
#################################################################################################################################
#--------------------------------------------------------------------------------------------------------------------------------
get-extras
#################################################################################################################################
