...
# Confirmation dialog
if dialog --title "Confirm" --yesno "Do you want to proceed the uninstall and delete the folders? The container's data will be deleted!!! Select 'yes' to continue." 10 60; then
    rm -rf ~/pro/steam   
