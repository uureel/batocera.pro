...
gdk-pixbuf-xlib gdk-pixbuf2 xarchiver gnome-boxes mc vifm nnn krusader krename kate \
imagemagick dnsmasq dmidecode"
...
7-zip-bin antimicrox lutris-git sublime-text-4 atoms-git chiaki"
