...
7-zip-bin antimicrox lutris-git sublime-text-4 freefilesync yuzu-early-access yuzu-mainline-bin \
ryujinx-bin ryujinx-ldn-bin ryujinx-ava-bin citra-canary-bin citra-nightly-bin"
