...
kate kmod pciutils xrdp x11vnc tigervnc onboard remmina vinagre freerdp sunshine btrfs-progs tre \
...
screenfetch glances konsole mullvad-browser-bin discord pcem cuda-tools nvidia-container-toolkit libnvidia-container"
