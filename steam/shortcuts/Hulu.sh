...
#------------------------------------------------
  "$conty" \
          ...
          --bind / /batocera \
  bash -c 'prepare && source /opt/env && dbus-run-session /opt/google/chrome/google-chrome --no-sandbox --test-type --start-fullscreen --force-device-scale-factor=1.6 "hulu.com"'
#------------------------------------------------
# batocera-mouse hide
#------------------------------------------------
